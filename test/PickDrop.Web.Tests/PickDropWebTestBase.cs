...
using PickDrop.Models.TokenAuth;
...
{
    public abstract class PickDropWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PickDropWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PickDropWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PickDropDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PickDropDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PickDropDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PickDropDbContext, Task<T>> func)
        {
            T result;
